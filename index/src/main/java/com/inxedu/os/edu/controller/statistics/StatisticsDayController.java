 ...
 */
	...
	@RequestMapping("/statistics/create/answer")
	@ResponseBody
	
	public  Map<String, Object> createAnswer(HttpServletRequest request){
		Map<String,Object> json = new HashMap<String,Object>();
		String problems = request.getParameter("startTime");
		String answer = request.getParameter("endTime");
		String operate = request.getParameter("operate");
		
	//	System.out.println(problems);
		answerService.createAnswer(problems,answer,operate);

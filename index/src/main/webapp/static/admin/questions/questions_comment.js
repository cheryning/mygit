...
function delQuestionsCommentSon(commentId){
	if(confirm("是否删除此问答评论吗?")){
		$.ajax({
			url:"/index/admin/questionscomment/delComment/"+commentId,
			data:{
			},
			dataType:"json",
			type:"post",
...
function delQuestionsComment(commentId){
	if(confirm("是否删除此问答回复,及问答回复下的所有评论吗?")){
		$.ajax({
			url:"/index/admin/questionscomment/del/"+commentId,
			data:{
			},
			dataType:"json",
			type:"post",
...
function acceptComment(id){
	$.ajax({
		url:"/index/admin/questionscomment/ajax/acceptComment/"+id,
		data:{
		},
		type:"post",
		dataType:"json",
...
function getCommentContent(questionsCommentId){
	//closedData();
	$.ajax({
		url:"/index/admin/questionscomment/getCommentById/"+questionsCommentId,
		type:'post',
		dataType:'json',
		success:function(result){
			if(result.success==true){
...
function updateQuestionComment(){
	...
	$.ajax({
		url:"/index/admin/questionscomment/updQuestionComment",
		data:{

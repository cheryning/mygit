                    ...
                    '<div>'+
                        '<ol class="e-login-options">'+
                            ...
                            '<li>'+
                                ...
                                '<a href="javascript:void(0)" title="" class="vam ml10 disIb fl"><img onclick="this.src=\'/index/ran/random?random=\'+Math.random()" alt="验证码，点击图片更换" src="/index/ran/random" width="86" height="40"/></a>'+
	...
	$.ajax({
		...
		success:function(result){
			if(result.success==false){
				...
				if(type==1){
					window.location.href="/index/uc/index";
				}else{

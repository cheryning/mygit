		...
		<dd class="u-m-dd">
			<ul>
				<li>
					<span>我的学习</span>
					<ol>
						<li><a href="${ctx}/uc/index" title="">课程</a></li>
						<li><a href="${ctx}/front/showcoulist" title="" target="view_window">选课中心</a></li>
						<li><a href="${ctx}/uc/myFavorites" title="">我的收藏</a></li>
					</ol>
				</li>
			</ul>
			<ul>
				<li>
					<span>我的问答</span>
					<ol>
						<li><a href="${ctx}/uc/myquestions/list" title="">我的提问</a></li>
						<li><a href="${ctx}/uc/myrepquestions/list" title="">我的回答</a></li>
					</ol>
				</li>
			</ul>
			<ul>
			...
			<ul>
				<li>
					<span>我的消息</span>
					<ol>
						<li><a href="${ctx}/uc/letter" title="">系统消息</a></li>

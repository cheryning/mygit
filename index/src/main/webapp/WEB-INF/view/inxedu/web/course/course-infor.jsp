				...
				<aside class="c-attr-wrap">
					<section class="ml20 mr15">
						...
						<section class="c-attr-mt">
									...
									<a href="javascript:void(0)" title="立即观看" onclick="if(isLogin()){ window.location.href='/index/uc/play/${course.courseId }'} else{lrFun();} " class="comm-btn c-btn-3">立即观看</a>
				...
				<aside class="thr-attr-box">
					<ol class="thr-attr-ol clearfix">
						<li><p>&nbsp;</p>
							...
							<aside>
								<span class="c-fff f-fM">${course.courseName}</span><br>

			...
			<div class="pr15">
				...
				<!-- /学习进度条 结束-->
					...
					<div class="p-h-video of">
						...
						<a href="javascript:void(0)" onclick="vedioClick(66)" title="${course.courseName}" class="v-play-btn">
							<em class="icon30">&nbsp;</em>
						</a>
					<!--  	
					</section>
...
<script type="text/javascript" src="${ctx}/static/inxweb/front/courseInfo.js"></script>
	...
	<script src="${ctx}/static/inxweb/comment/comment.js" type="text/javascript"></script><!-- 评论js -->
	...
	function getCourseKpointList(courseId,type) {
		$.ajax({
			url : baselocation + "/index/front/ajax/courseKpointList/"+courseId+"/"+type,
			data:{},
			type : 'post',
			dataType : 'text',

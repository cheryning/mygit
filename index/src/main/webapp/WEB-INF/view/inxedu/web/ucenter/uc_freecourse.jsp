		...
		<section>
			<div>
				<section class="c-infor-tabTitle c-tab-title">
					...
					<a href="${ctx }/uc/index" title="免费课程" class="current">课程</a>
				</section>
			</div>
			<div class="mt40">
				<c:if test="${courseList==null || courseList.size()<=0 }">
					...
					<section class="no-data-wrap">
						...
						<span class="c-666 fsize14 ml10 vam">暂无课程！</span>
					</section>
					<!-- /无数据提示 结束-->
				</c:if>
									...
									<li>
										<div class="cc-l-wrap">
											...
											<h3 class="hLh30 txtOf mt10">
												...
												<c:if test="${course.pageBuycount == 1}">
												<span>考核通过</span>
												</c:if>
												<c:if test="${course.pageBuycount == 0}">
												<c:if test="${course.studyPercent>=100}">
												<a href="${ctx}/an/answer/${course.courseId}" >测试</a>
												</c:if>
												</c:if>
											</h3>

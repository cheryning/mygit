      ...
      -->
		<div class="">
			...
			<ul class="dash">
				...
				<li>
					<a href="${ctx}/admin/article/initcreate" target="content" title="新增通知" class="tooltip">
						<img src="${ctx}/static/admin/assets/icons/8_48x48.png" alt="" />
						<span>新增通知</span>
					</a>
				</li>
				<li>
					<a href="${ctx}/admin/article/showlist" target="content" title="通知列表" class="tooltip">
		...
		<span>
			...
			<b>通知数:</b> ${webCountMap.articleCount}&nbsp;

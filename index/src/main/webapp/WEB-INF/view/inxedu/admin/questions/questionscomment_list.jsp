			...
			<tbody>
				<c:forEach items="${questionsCommentList}" var="questionsComment" varStatus="index">
					<tr <c:if test="${index.count%2==1 }">class="odd"</c:if>>
						...
						<!-- 	<button onclick="window.location.href='${ctx}/admin/questionscomment/querybycommentid/${questionsComment.questionId}'" class="ui-state-default ui-corner-all" type="button">查看评论</button>
						 -->

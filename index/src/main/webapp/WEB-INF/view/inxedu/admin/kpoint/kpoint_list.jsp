...
<script type="text/javascript">
        ...
        function uploadPicLoad(fileupload,showId,fileQueue){
         //   $("#fileuploadUploader").remove();
            $("#"+fileupload).uploadify({
                ...
                'buttonImg' : '${ctx}/static/common/uploadify/liulan.png',//使用图片按钮，设定图片的路径即可
                'width' : 105,
                ...
                'cancelImg' : '${ctx}/static/common/uploadify/cancel.png',
        ...
        function uploadAudios(controlId,ids,errId){
            $("#"+controlId).uploadify({
                'uploader' : baselocation+'${ctx}/static/common/uploadify/uploadify.swf', //上传控件的主体文件，flash控件  默认值='uploadify.swf'
